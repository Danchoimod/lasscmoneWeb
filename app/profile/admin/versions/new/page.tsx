  ...
  return (
    <MainLayout>
      <div className="flex items-center text-xs text-gray-400 mb-6 font-bold uppercase tracking-tight">
        ...
        <span>Versions</span>
        <ChevronRight size={12} className="mx-1" />
        <span className="text-gray-600 font-medium tracking-normal">New Version</span>
      </div>

      <div className="space-y-6">
        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 flex items-center justify-between">
          <h1 className="text-base font-bold text-gray-800 uppercase tracking-tight">Create New Version</h1>
        </div>
        <VersionForm />
      </div>
    </MainLayout>
