...
export default function ProjectPage() {
  ...
  return (
    <div className="bg-white p-4 sm:p-8 border border-gray-300 transition-none min-h-screen rounded-none">
      <SectionHeading>Project Details</SectionHeading>

      {/* FIXED: Classic Tab Navigation with Horizontal Scroll for Mobile */}
          ...
          <div className="flex min-w-max">
            {steps.map((step) => (
              <button
                ...
                className={`px-6 py-3 text-[10px] sm:text-xs font-bold uppercase tracking-tight border-t border-x -mb-[1px] transition-none rounded-none ${
                  currentStep === step.id
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input className="border border-gray-300 bg-gray-50 p-2.5 text-sm outline-none focus:bg-white focus:border-gray-800 rounded-none" placeholder="e.g. My Awesome Mod" />
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input className="border border-gray-300 bg-gray-50 p-2.5 text-sm outline-none focus:bg-white focus:border-gray-800 rounded-none" placeholder="Short summary..." />
                </div>
              </div>

              <div className="space-y-2">
                <label className="text-xs font-bold uppercase text-gray-700">Project Logo</label>
                <div className="aspect-square border border-gray-300 bg-gray-100 flex items-center justify-center p-4 text-center cursor-pointer hover:bg-gray-200 border-dashed rounded-none">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-gray-300 mt-10 gap-4">
        <button
          ...
          className={`w-full sm:w-auto px-6 py-2 border border-gray-300 text-xs font-bold uppercase tracking-widest transition-none rounded-none ${
