...
export default function FollowClient({ initialData }: { initialData: FollowingUser[] }) {
    return (
        <div className="bg-white p-8 border border-gray-300 rounded-none transition-none animate-in fade-in duration-500">
