        ...
        <div className="w-full rounded-sm border border-[#D1D4D7] bg-white shadow-sm overflow-hidden">
          ...
          <div className="p-4 md:p-8 text-[15px] leading-[1.7] text-[#444] space-y-6 wrap-break-word overflow-hidden">
            <section className="space-y-4">
              <p>
                At <a href="https://lflauncher.org" className="text-[#4F8A10] hover:underline font-medium">LFLauncher.org</a>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by LFLauncher.org and how we use it.
              </p>
              <p>
            ...
            <p className="pt-4 border-t border-[#EEE]">
              The Privacy Policy of <a href="#" className="text-[#4F8A10] hover:underline font-medium">LFLauncher.org</a> was last modified on <strong>{lastModified}</strong>
            </p>
          </div>
        </div>
      </main>
